...
class LLMPred:
    ...
    def _get_templates(self, class_json):
        ...
        for class_name, desc in class_json.items():
            q = f'Given the description for the category "{class_name}" being: {desc}. Do you think a sample with the metadata "WILDCARD" is part of this? Reply with JUST YES or NO, no explanation.'
