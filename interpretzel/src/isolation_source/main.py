...
def pretzel_iso_gen():
    ...
    parser.add_argument('-m', nargs="?", help='Model to use', type = str, const="meta-llama/Meta-Llama-3-8B-Instruct")
...
def pretzel_iso_pred():
    ...
    parser.add_argument('-m', nargs="?", help='Model to use', type = str, const="meta-llama/Meta-Llama-3-8B-Instruct")
    parser.add_argument('-v', nargs="?", help='verbose output', type = str, const="")
    parser.add_argument('-p', nargs="?", help='percentage cutoff', type = float, const=99.9)
    args = parser.parse_args()
